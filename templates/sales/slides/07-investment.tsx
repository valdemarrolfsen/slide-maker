  ...
  return (
    <Slide className="sales-slide" label="Pulse × Acme Revenue">
      ...
      <div className="sales-pricing">
        <article className="sales-price-card"><span className="sales-price-tag">PILOT</span><h3>Launch</h3><div className="sales-price">$36k <small>90-day pilot</small></div><ul><li>25 users and 250 accounts</li><li>CRM + one product source</li><li>Three priority signals</li><li>Weekly value review</li></ul><div className="sales-price-outcome"><small>SUCCESS TARGET</small><b>Prove action speed</b><span>Below four days with ≥70% weekly adoption</span></div><strong>Best for technical proof</strong></article>
        <article className="sales-price-card recommended"><span className="sales-price-tag">RECOMMENDED</span><h3>Scale</h3><div className="sales-price">$96k <small>annual</small></div><ul><li>100 users and 2,500 accounts</li><li>CRM, product, support, intent</li><li>Unlimited signal plays</li><li>Dedicated success lead</li></ul><div className="sales-price-outcome"><small>SUCCESS TARGET</small><b>Prove revenue lift</b><span>Measure forecast and expansion movement</span></div><strong>Best path to business proof</strong></article>
        <article className="sales-price-card"><span className="sales-price-tag">ENTERPRISE</span><h3>Transform</h3><div className="sales-price">Custom</div><ul><li>Multiple regions and teams</li><li>Warehouse and custom sources</li><li>Advanced governance</li><li>Embedded value program</li></ul><div className="sales-price-outcome"><small>SUCCESS TARGET</small><b>Standardize the motion</b><span>One operating model across every region</span></div><strong>Best for global rollout</strong></article>
      </div>
